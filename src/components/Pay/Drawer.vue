  ...
  el-drawer(title='账号配置',size="70%", @close='cancel', :visible.sync='visible', direction='rtl', custom-class='drawer', ref='drawer')
    .container.layout-column
      .wjp-tools.layout-row__between
        div
          el-button(v-if="(userinfo.roleId ==4 || userinfo.roleId ==1)&&!(single&&table.length<2)" v-show="table.length === 0 || payWayId === 10" type='primary' @click="addChannel" size="mini") 添加收款方式
        //- .layout-row.buttons
