...
.orders-container.layout-column
    ...
    .wjp-content.flex.layout-column
            ...
            el-table-column(prop='payStatusDictValue' width="150" label='操作' fixed="right" align="center")
                template(slot-scope='scope')
                  .layout-row__between
                    ...
                    el-button(type="primary" size="mini" v-if="scope.row.payStatusDictValue!=='支付成功'" v-show="userinfo.roleId != 2" @click="supplement(scope.row)") 补 单
        ...
        .page.layout-row.align-center.right
            ...
            :total="totalPage")
    add-order(@finish="getTableData" :payWayId="payWayId" :visible.sync="addVisible" :payWay='payWay' :isQF="isQF")
</template>
