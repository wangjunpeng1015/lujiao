...
.layout-column
  ...
  el-table(
    ...
    el-table-column(label="成功笔数" show-overflow-tooltip prop="successOrderNum")
    el-table-column(label="总笔数" show-overflow-tooltip prop="orderNum")
      ...
      getAllAcount({
        ...
        .then(res => {
          ...
          content.forEach(item => {
            item.successOrderNum = item.orderNum - item.failureOrderNum
