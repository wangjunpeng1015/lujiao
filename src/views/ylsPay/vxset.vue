...
.layout-column
  ...
  el-table(size="mini" :row-class-name="tableRowClassName" v-loading="loading" , :data="list",style='width: 100%')
...
export default {
  ...
  methods: {
    ...
    saveAccount() {
      ...
      let account = this.news.account + "-云微信";
      let param = Object.assign({}, this.news, {
        account: this.news.account + "-云微信"
      });
