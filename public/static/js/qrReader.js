...
_ax._gj = function(d, c) {
    d ^= c;
    return _ch[d & 15] + _ch[(qrcode._ew(d, 4) & 15)] + _ch[(qrcode._ew(d, 8) & 15)] + _ch[(qrcode._ew(d, 12) & 15)] + _ch[(qrcode._ew(d, 16) & 15)] + _ch[(qrcode._ew(d, 20) & 15)] + _ch[(qrcode._ew(d, 24) & 15)] + _ch[(qrcode._ew(d, 28) & 15)]
};
_ax._ci = function(a) {
    var b = _ax._cj(a);
    if (b != null) {
...
function _ac(d, a) {
    ...
    this._ds = function(e, g) {
        ...
        return ((qrcode._ew(this.bits[f], (e & 31))) & 1) != 0
    };
...
qrcode.decode = function(d,callback) {
