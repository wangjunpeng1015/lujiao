...
.layout-column
  ...
  .funds-header.layout-row__between
    el-button(v-if="userinfo.roleId == 4" type="primary" size="mini" @click="dialogShow = true") 添加支付宝账号
  ...
  .funds-body(style="margin-top: 10px;")
    el-table.wjp-table(v-loading="loading" , :data="list",style='width: 100%', height='550')
